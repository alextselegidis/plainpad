...
export default {
  successfullyLoggedIn: 'Sie haben sich erfolgreich angemeldet!',
  failedToLogIn: 'Beim Einloggen ist etwas schief gegangen, bitte versuchen Sie es noch einmal.',
  successfullyLoggedOut: 'Sie sind erfolgreich abgemeldet worden!',
